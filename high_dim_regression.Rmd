...
results_folder_all <- "results/highdim/regression/prop_widen/cor/"
start_time <- Sys.time()
#set.seed(3)
set.seed(100)
...
for (m in c(0.2, 0.4, 0.6, 0.8, 1)) {
  results_folder <- glue::glue(results_folder_all, "m{m}_")
...
tibble(
  ...
  "method" = c("conf", "pl", "bc", "bct"),
               #,"bc_true_prop","bc_true_mu", "bc_rt", "conf1se", "pl1se",  "oracle_plugin_1se","oracle_plugin", "regression_diff"),
  "sim" = sim_num,
