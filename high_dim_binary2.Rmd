...
for (k in c(3:6)) { # try 10 or 20
  ...
  results <- foreach(sim_num = 1:n_sim) %dopar% {
    ...
    results <- rbind(results, tibble(
      ...
      "method" = c("conf", "pl", "bc", "bct", "bc_true_prop", "bc_true_mu", "conf1se", "pl1se", "oracle_plugin_1se", "oracle_plugin", "regression_diff"),
      "sim" = sim_num,
