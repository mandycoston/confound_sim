...
Fixing n = 1000, d = 500 and varying parameters.
This is intended as a debugging tool in order to develop code for each parameter 
which should be in a script like binary_vary_P.R 
